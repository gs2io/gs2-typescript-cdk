...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.receiveScript = (_d = options === null || options === void 0 ? void 0 : options.receiveScript) !== null && _d !== void 0 ? _d : null;
    ...
    properties() {
        ...
        if (this.receiveScript != null) {
            properties["ReceiveScript"] = (_c = this.receiveScript) === null || _c === void 0 ? void 0 : _c.properties();
        }
