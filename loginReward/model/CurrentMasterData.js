...
class CurrentMasterData extends model_1.CdkResource {
    constructor(stack, namespaceName, bonusModels) {
        super("LoginReward_CurrentBonusMaster_" + namespaceName);
    ...
    properties() {
        ...
        if (this.bonusModels != null) {
            settings["bonusModels"] = this.bonusModels.map(v => v.properties());
        }
