...
class IncrementalRateModel {
    ...
    static calculateTypeIsLinear(name, consumeAction, exchangeCountId, maximumExchangeCount, baseValue, coefficientValue, options = null) {
        return new IncrementalRateModel(name, consumeAction, IncrementalRateModelCalculateType_1.IncrementalRateModelCalculateType.LINEAR, exchangeCountId, maximumExchangeCount, {
            baseValue: baseValue,
    ...
    static calculateTypeIsPower(name, consumeAction, exchangeCountId, maximumExchangeCount, coefficientValue, options = null) {
        return new IncrementalRateModel(name, consumeAction, IncrementalRateModelCalculateType_1.IncrementalRateModelCalculateType.POWER, exchangeCountId, maximumExchangeCount, {
            coefficientValue: coefficientValue,
            metadata: options === null || options === void 0 ? void 0 : options.metadata,
            acquireActions: options === null || options === void 0 ? void 0 : options.acquireActions,
        });
    }
    static calculateTypeIsGs2Script(name, consumeAction, exchangeCountId, maximumExchangeCount, calculateScriptId, options = null) {
        return new IncrementalRateModel(name, consumeAction, IncrementalRateModelCalculateType_1.IncrementalRateModelCalculateType.GS2_SCRIPT, exchangeCountId, maximumExchangeCount, {
