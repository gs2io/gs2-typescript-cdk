...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.transactionSettingV2 = (_e = options === null || options === void 0 ? void 0 : options.transactionSettingV2) !== null && _e !== void 0 ? _e : null;
        this.exchangeScript = (_f = options === null || options === void 0 ? void 0 : options.exchangeScript) !== null && _f !== void 0 ? _f : null;
        this.incrementalExchangeScript = (_g = options === null || options === void 0 ? void 0 : options.incrementalExchangeScript) !== null && _g !== void 0 ? _g : null;
        this.acquireAwaitScript = (_h = options === null || options === void 0 ? void 0 : options.acquireAwaitScript) !== null && _h !== void 0 ? _h : null;
    ...
    properties() {
        ...
        if (this.exchangeScript != null) {
            properties["ExchangeScript"] = (_c = this.exchangeScript) === null || _c === void 0 ? void 0 : _c.properties();
        }
        if (this.incrementalExchangeScript != null) {
            properties["IncrementalExchangeScript"] = (_d = this.incrementalExchangeScript) === null || _d === void 0 ? void 0 : _d.properties();
        }
        if (this.acquireAwaitScript != null) {
            properties["AcquireAwaitScript"] = (_e = this.acquireAwaitScript) === null || _e === void 0 ? void 0 : _e.properties();
        }
