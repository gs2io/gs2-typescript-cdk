...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.applyBuffScript = (_b = options === null || options === void 0 ? void 0 : options.applyBuffScript) !== null && _b !== void 0 ? _b : null;
    ...
    properties() {
        ...
        if (this.applyBuffScript != null) {
            properties["ApplyBuffScript"] = (_a = this.applyBuffScript) === null || _a === void 0 ? void 0 : _a.properties();
        }
    ...
    masterData(buffEntryModels) {
        new CurrentMasterData_1.default(this.stack, this.name, buffEntryModels).addDependsOn(this);
        return this;
    }
}
