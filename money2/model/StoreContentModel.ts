...
export default class StoreContentModel {
    ...
    private readonly appleAppStore: AppleAppStoreContent|null = null;
    private readonly googlePlay: GooglePlayContent|null = null;

    public constructor(
        name: string,
        options: StoreContentModelOptions|null = null,
    ) {
        this.name = name;
