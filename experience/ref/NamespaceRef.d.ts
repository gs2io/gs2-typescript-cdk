...
export default class NamespaceRef {
    ...
    addExperience(experienceName: string, propertyId: string, experienceValue?: number | null, userId?: string): AddExperienceByUserId;
    ...
    verifyRank(experienceName: string, verifyType: StatusVerifyType, propertyId: string, rankValue?: number | null, userId?: string): VerifyRankByUserId;
    verifyRankCap(experienceName: string, verifyType: StatusVerifyType, propertyId: string, rankCapValue: number, userId?: string): VerifyRankCapByUserId;
    grn(): string;
}
