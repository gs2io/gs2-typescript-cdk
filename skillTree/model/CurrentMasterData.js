...
class CurrentMasterData extends model_1.CdkResource {
    constructor(stack, namespaceName, nodeModels) {
        super("SkillTree_CurrentTreeMaster_" + namespaceName);
        this.version = "2023-09-06";
    ...
    properties() {
        ...
        if (this.nodeModels != null) {
            settings["nodeModels"] = this.nodeModels.map(v => v.properties());
        }
