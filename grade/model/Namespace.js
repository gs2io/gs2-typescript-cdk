...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.changeGradeScript = (_c = options === null || options === void 0 ? void 0 : options.changeGradeScript) !== null && _c !== void 0 ? _c : null;
    ...
    properties() {
        ...
        if (this.changeGradeScript != null) {
            properties["ChangeGradeScript"] = (_b = this.changeGradeScript) === null || _b === void 0 ? void 0 : _b.properties();
        }
    ...
    masterData(gradeModels) {
        new CurrentMasterData_1.default(this.stack, this.name, gradeModels).addDependsOn(this);
        return this;
    }
}
