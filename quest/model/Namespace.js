...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.startQuestScript = (_d = options === null || options === void 0 ? void 0 : options.startQuestScript) !== null && _d !== void 0 ? _d : null;
        this.completeQuestScript = (_e = options === null || options === void 0 ? void 0 : options.completeQuestScript) !== null && _e !== void 0 ? _e : null;
        this.failedQuestScript = (_f = options === null || options === void 0 ? void 0 : options.failedQuestScript) !== null && _f !== void 0 ? _f : null;
    ...
    properties() {
        ...
        if (this.startQuestScript != null) {
            properties["StartQuestScript"] = (_c = this.startQuestScript) === null || _c === void 0 ? void 0 : _c.properties();
        }
        if (this.completeQuestScript != null) {
            properties["CompleteQuestScript"] = (_d = this.completeQuestScript) === null || _d === void 0 ? void 0 : _d.properties();
        }
        if (this.failedQuestScript != null) {
            properties["FailedQuestScript"] = (_e = this.failedQuestScript) === null || _e === void 0 ? void 0 : _e.properties();
        }
    ...
    masterData(groups) {
        new CurrentMasterData_1.default(this.stack, this.name, groups).addDependsOn(this);
        return this;
    }
}
