...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.doneUploadScript = (_c = options === null || options === void 0 ? void 0 : options.doneUploadScript) !== null && _c !== void 0 ? _c : null;
    ...
    properties() {
        ...
        if (this.doneUploadScript != null) {
            properties["DoneUploadScript"] = (_b = this.doneUploadScript) === null || _b === void 0 ? void 0 : _b.properties();
        }
        return properties;
    }
    ref() {
