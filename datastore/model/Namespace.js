...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.doneUploadScript = (_d = options === null || options === void 0 ? void 0 : options.doneUploadScript) !== null && _d !== void 0 ? _d : null;
    ...
    properties() {
        ...
        if (this.doneUploadScript != null) {
            properties["DoneUploadScript"] = (_c = this.doneUploadScript) === null || _c === void 0 ? void 0 : _c.properties();
        }
        return properties;
    }
    ref() {
