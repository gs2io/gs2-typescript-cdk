...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.doneUploadScript = (_e = options === null || options === void 0 ? void 0 : options.doneUploadScript) !== null && _e !== void 0 ? _e : null;
    ...
    properties() {
        ...
        if (this.doneUploadScript != null) {
            properties["DoneUploadScript"] = (_d = this.doneUploadScript) === null || _d === void 0 ? void 0 : _d.properties();
        }
        return properties;
    }
    ref() {
