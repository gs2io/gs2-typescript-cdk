...
class Namespace extends model_1.CdkResource {
    ...
    masterData(balanceParameterModels, rarityParameterModels) {
        new CurrentMasterData_1.default(this.stack, this.name, balanceParameterModels, rarityParameterModels).addDependsOn(this);
        return this;
    }
}
