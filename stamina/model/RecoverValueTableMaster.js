...
const RecoverValueTableMasterRef_1 = tslib_1.__importDefault(require("../ref/RecoverValueTableMasterRef"));
class RecoverValueTableMaster extends core_1.default.CdkResource {
    ...
    ref(namespaceName) {
        return new RecoverValueTableMasterRef_1.default(namespaceName, this.name);
    }
    getAttrRecoverValueTableId() {
        return new func_1.GetAttr(null, null, "Item.RecoverValueTableId");
    }
}
