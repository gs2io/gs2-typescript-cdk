...
const RecoverValueTableRef_1 = tslib_1.__importDefault(require("../ref/RecoverValueTableRef"));
class RecoverValueTable {
    ...
    ref(namespaceName) {
        return new RecoverValueTableRef_1.default(namespaceName, this.name);
    }
}
