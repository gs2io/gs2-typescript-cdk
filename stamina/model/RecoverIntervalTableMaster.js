...
const RecoverIntervalTableMasterRef_1 = tslib_1.__importDefault(require("../ref/RecoverIntervalTableMasterRef"));
class RecoverIntervalTableMaster extends core_1.default.CdkResource {
    ...
    ref(namespaceName) {
        return new RecoverIntervalTableMasterRef_1.default(namespaceName, this.name);
    }
    getAttrRecoverIntervalTableId() {
        return new func_1.GetAttr(null, null, "Item.RecoverIntervalTableId");
    }
}
