...
const RecoverIntervalTableRef_1 = tslib_1.__importDefault(require("../ref/RecoverIntervalTableRef"));
class RecoverIntervalTable {
    ...
    ref(namespaceName) {
        return new RecoverIntervalTableRef_1.default(namespaceName, this.name);
    }
}
