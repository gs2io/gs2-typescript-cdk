...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        var _a, _b, _c;
        super("Ranking2_Namespace_" + name);
    ...
    masterData(globalRankingModels, clusterRankingModels, subscribeRankingModels) {
        new CurrentMasterData_1.default(this.stack, this.name, globalRankingModels, clusterRankingModels, subscribeRankingModels).addDependsOn(this);
        return this;
    }
}
