...
class VerifyClusterRankingScoreByUserId extends model_1.VerifyAction {
    constructor(namespaceName, rankingName, clusterName, verifyType, score, season = null, multiplyValueSpecifyingQuantity = null, timeOffsetToken = null, userId = "#{userId}") {
        super();
        this.season = null;
...
exports.default = VerifyClusterRankingScoreByUserId;
//# sourceMappingURL=VerifyClusterRankingScoreByUserId.js.map