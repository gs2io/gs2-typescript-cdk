...
class NamespaceRef {
    ...
    currentItemModelMaster() {
        return new CurrentItemModelMasterRef_1.default(this.namespaceName);
    }
    inventoryModel(inventoryName) {
        return new InventoryModelRef_1.default(this.namespaceName, inventoryName);
    }
    inventoryModelMaster(inventoryName) {
        return new InventoryModelMasterRef_1.default(this.namespaceName, inventoryName);
    }
    grn() {
