...
class VerifySimpleItemByUserId extends model_1.ConsumeAction {
    constructor(namespaceName, inventoryName, itemName, verifyType, count, multiplyValueSpecifyingQuantity = null, timeOffsetToken = null, userId = "#{userId}") {
        super();
...
exports.default = VerifySimpleItemByUserId;
//# sourceMappingURL=VerifySimpleItemByUserId.js.map