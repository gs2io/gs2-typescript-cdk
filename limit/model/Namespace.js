...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.countUpScript = (_d = options === null || options === void 0 ? void 0 : options.countUpScript) !== null && _d !== void 0 ? _d : null;
    ...
    properties() {
        ...
        if (this.countUpScript != null) {
            properties["CountUpScript"] = (_c = this.countUpScript) === null || _c === void 0 ? void 0 : _c.properties();
        }
