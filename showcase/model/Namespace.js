...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.buyScript = (_c = options === null || options === void 0 ? void 0 : options.buyScript) !== null && _c !== void 0 ? _c : null;
    ...
    properties() {
        ...
        if (this.buyScript != null) {
            properties["BuyScript"] = (_b = this.buyScript) === null || _b === void 0 ? void 0 : _b.properties();
        }
