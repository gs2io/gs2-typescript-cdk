...
class Namespace extends model_1.CdkResource {
    constructor(stack, name, options = null) {
        ...
        this.buyScript = (_d = options === null || options === void 0 ? void 0 : options.buyScript) !== null && _d !== void 0 ? _d : null;
    ...
    properties() {
        ...
        if (this.buyScript != null) {
            properties["BuyScript"] = (_c = this.buyScript) === null || _c === void 0 ? void 0 : _c.properties();
        }
