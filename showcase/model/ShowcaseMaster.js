...
const ShowcaseMasterRef_1 = tslib_1.__importDefault(require("../ref/ShowcaseMasterRef"));
class ShowcaseMaster extends core_1.default.CdkResource {
    constructor(stack, namespaceName, name, displayItems, options) {
        var _a, _b, _c;
    ...
    ref(namespaceName) {
        return new ShowcaseMasterRef_1.default(namespaceName, this.name);
    }
    getAttrShowcaseId() {
        return new func_1.GetAttr(null, null, "Item.ShowcaseId");
    }
}
